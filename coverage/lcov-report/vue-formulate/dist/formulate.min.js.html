...
<html lang="en">
<head>
    <title>Code coverage report for vue-formulate/dist/formulate.min.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">vue-formulate/dist</a> formulate.min.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>0/254</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">0% </span>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>0/328</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1528'></a><a href='#L1528'>1528</a></td><td class="line-coverage quiet"><span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var Formulate = (<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (exports, isPlainObject, nanoid) {</span>
  'use strict';
&nbsp;
<span class="cstat-no" title="statement not covered" >  isPlainObject = isPlainObject &amp;&amp; isPlainObject.hasOwnProperty('default') ? isPlainObject['default'] : isPlainObject;</span>
<span class="cstat-no" title="statement not covered" >  nanoid = nanoid &amp;&amp; nanoid.hasOwnProperty('default') ? nanoid['default'] : nanoid;</span>
&nbsp;
  var library = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >map </span>(original, callback) {
    var obj = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >    for (var key in original) {</span>
<span class="cstat-no" title="statement not covered" >      obj[key] = callback(key, original[key]);</span>
    }
...
&nbsp;
   ...
   * @param {*} objB
   */
  function <span class="fstat-no" title="function not covered" >shallowEqualObjects </span>(objA, objB) {
<span class="cstat-no" title="statement not covered" >    if (objA === objB) {</span>
<span class="cstat-no" title="statement not covered" >      return true</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!objA || !objB) {</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
    var aKeys = <span class="cstat-no" title="statement not covered" >Object.keys(objA);</span>
    var bKeys = <span class="cstat-no" title="statement not covered" >Object.keys(objB);</span>
    var len = <span class="cstat-no" title="statement not covered" >aKeys.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (bKeys.length !== len) {</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; len; i++) {</span>
      var key = <span class="cstat-no" title="statement not covered" >aKeys[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (objA[key] !== objB[key]) {</span>
<span class="cstat-no" title="statement not covered" >        return false</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    return true</span>
...
&nbsp;
   ...
   * @return {object}
   */
  var context = <span class="cstat-no" title="statement not covered" >{</span>
    context: function <span class="fstat-no" title="function not covered" >context </span>() {
<span class="cstat-no" title="statement not covered" >      if (this.debug) {</span>
<span class="cstat-no" title="statement not covered" >        console.log(((this.type) + " re-context"));</span>
      }
<span class="cstat-no" title="statement not covered" >      return defineModel.call(this, Object.assign({}, {type: this.type,</span>
        value: this.value,
...
&nbsp;
   ...
   * @return {object}
   */
  function <span class="fstat-no" title="function not covered" >typeContext </span>() {
    var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    switch (this.classification) {</span>
      case 'select':
<span class="cstat-no" title="statement not covered" >        return {</span>
          options: createOptionList.call(this, this.options),
          optionGroups: this.optionGroups ? map(this.optionGroups, <span class="fstat-no" title="function not covered" >fu</span>nction (k, v) { <span class="cstat-no" title="statement not covered" >return createOptionList.call(this$1, v); </span>}) : false,
          placeholder: this.$attrs.placeholder || false
        }
      case 'group':
<span class="cstat-no" title="statement not covered" >        if (this.options) {</span>
<span class="cstat-no" title="statement not covered" >          return {</span>
            options: createOptionList.call(this, this.options)
          }
        }
...
&nbsp;
   ...
   * @return {object}
   */
  function <span class="fstat-no" title="function not covered" >elementAttributes </span>() {
    var attrs = <span class="cstat-no" title="statement not covered" >Object.assign({}, this.localAttributes);</span>
<span class="cstat-no" title="statement not covered" >    if (this.id) {</span>
<span class="cstat-no" title="statement not covered" >      attrs.id = this.id;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      attrs.id = this.defaultId;</span>
    }
<span class="cstat-no" title="statement not covered" >    return attrs</span>
  }
&nbsp;
  /**
   ...
   */
  function <span class="fstat-no" title="function not covered" >logicalLabelPosition </span>() {
<span class="cstat-no" title="statement not covered" >    if (this.labelPosition) {</span>
<span class="cstat-no" title="statement not covered" >      return this.labelPosition</span>
    }
<span class="cstat-no" title="statement not covered" >    switch (this.classification) {</span>
      case 'box':
<span class="cstat-no" title="statement not covered" >        return 'after'</span>
      default:
<span class="cstat-no" title="statement not covered" >        return 'before'</span>
    }
  }
&nbsp;
  /**
   ...
   */
  function <span class="fstat-no" title="function not covered" >nameOrFallback </span>() {
<span class="cstat-no" title="statement not covered" >    if (this.name === true) {</span>
<span class="cstat-no" title="statement not covered" >      return ((this.type) + "_" + (this.elementAttributes.id))</span>
    }
<span class="cstat-no" title="statement not covered" >    if (this.name === false) {</span>
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >isVmodeled </span>() {
<span class="cstat-no" title="statement not covered" >    return !!(this.$options.propsData.hasOwnProperty('formulateValue') &amp;&amp;</span>
      this._events &amp;&amp;
...
&nbsp;
   ...
   * @return {array}
   */
  function <span class="fstat-no" title="function not covered" >createOptionList </span>(options) {
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(options) &amp;&amp; options &amp;&amp; typeof options === 'object') {</span>
      var optionList = <span class="cstat-no" title="statement not covered" >[];</span>
      var that = <span class="cstat-no" title="statement not covered" >this;</span>
<span class="cstat-no" title="statement not covered" >      for (var value in options) {</span>
<span class="cstat-no" title="statement not covered" >        optionList.push({ value: value, label: options[value], id: ((that.elementAttributes.id) + "_" + value) });</span>
      }
<span class="cstat-no" title="statement not covered" >      return optionList</span>
    } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(options) &amp;&amp; !options.length) {</span>
<span class="cstat-no" title="statement not covered" >      return [{ value: this.value, label: (this.label || this.name), id: this.context.id || nanoid(9) }]</span>
    }
...
&nbsp;
   ...
   */
  function <span class="fstat-no" title="function not covered" >defineModel </span>(context) {
<span class="cstat-no" title="statement not covered" >    return Object.defineProperty(context, 'model', {</span>
...
&nbsp;
   ...
   **/
  function <span class="fstat-no" title="function not covered" >modelGetter </span>() {
    var model = <span class="cstat-no" title="statement not covered" >this.isVmodeled ? 'formulateValue' : 'internalModelProxy';</span>
<span class="cstat-no" title="statement not covered" >    if (this.type === 'checkbox' &amp;&amp; !Array.isArray(this[model]) &amp;&amp; this.options) {</span>
<span class="cstat-no" title="statement not covered" >      return []</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!this[model]) {</span>
<span class="cstat-no" title="statement not covered" >      return ''</span>
    }
<span class="cstat-no" title="statement not covered" >    return this[model]</span>
  }
&nbsp;
  /**
   * Set the value from a model.
   **/
  function <span class="fstat-no" title="function not covered" >modelSetter </span>(value) {
<span class="cstat-no" title="statement not covered" >    this.internalModelProxy = value;</span>
<span class="cstat-no" title="statement not covered" >    this.$emit('input', value);</span>
<span class="cstat-no" title="statement not covered" >    if (this.context.name &amp;&amp; typeof this.formulateFormSetter === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      this.formulateFormSetter(this.context.name, value);</span>
    }
  }
&nbsp;
  //
&nbsp;
  var script = <span class="cstat-no" title="statement not covered" >{</span>
    name: 'FormulateInput',
    inheritAttrs: false,
    inject: {
    ...
    data: function <span class="fstat-no" title="function not covered" >data </span>() {
<span class="cstat-no" title="statement not covered" >      return {</span>
        defaultId: nanoid(9),
        localAttributes: {},
    ...
    computed: Object.assign({}, context,
      {classification: function <span class="fstat-no" title="function not covered" >classification </span>() {
        var classification = <span class="cstat-no" title="statement not covered" >this.$formulate.classify(this.type);</span>
<span class="cstat-no" title="statement not covered" >        return (classification === 'box' &amp;&amp; this.options) ? 'group' : classification</span>
      },
      component: function <span class="fstat-no" title="function not covered" >component </span>() {
<span class="cstat-no" title="statement not covered" >        return (this.classification === 'group') ? 'FormulateInputGroup' : this.$formulate.component(this.type)</span>
      }}),
    watch: {
      '$attrs': {
        handler: function <span class="fstat-no" title="function not covered" >handler </span>(value) {
<span class="cstat-no" title="statement not covered" >          this.updateLocalAttributes(value);</span>
        },
        deep: true
      },
      internalModelProxy: function <span class="fstat-no" title="function not covered" >internalModelProxy </span>(newValue, oldValue) {
<span class="cstat-no" title="statement not covered" >        if (!this.isVmodeled &amp;&amp; !shallowEqualObjects(newValue, oldValue)) {</span>
<span class="cstat-no" title="statement not covered" >          this.context.model = newValue;</span>
        }
      },
      formulateValue: function <span class="fstat-no" title="function not covered" >formulateValue </span>(newValue, oldValue) {
<span class="cstat-no" title="statement not covered" >        if (this.isVmodeled &amp;&amp; !shallowEqualObjects(newValue, oldValue)) {</span>
<span class="cstat-no" title="statement not covered" >          this.context.model = newValue;</span>
        }
      }
    },
    created: function <span class="fstat-no" title="function not covered" >created </span>() {
<span class="cstat-no" title="statement not covered" >      if (this.formulateFormRegister &amp;&amp; typeof this.formulateFormRegister === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        this.formulateFormRegister(this.nameOrFallback, this);</span>
      }
<span class="cstat-no" title="statement not covered" >      this.updateLocalAttributes(this.$attrs);</span>
    },
    methods: {
      updateLocalAttributes: function <span class="fstat-no" title="function not covered" >updateLocalAttributes </span>(value) {
<span class="cstat-no" title="statement not covered" >        if (!shallowEqualObjects(value, this.localAttributes)) {</span>
<span class="cstat-no" title="statement not covered" >          this.localAttributes = value;</span>
        }
      }
    }
  };
&nbsp;
  function <span class="fstat-no" title="function not covered" >normalizeComponent(</span>template, style, script, scopeId, isFunctionalTemplate, moduleIdentifier
  /* server only */
  , shadowMode, createInjector, createInjectorSSR, createInjectorShadow) {
<span class="cstat-no" title="statement not covered" >    if (typeof shadowMode !== 'boolean') {</span>
<span class="cstat-no" title="statement not covered" >      createInjectorSSR = createInjector;</span>
<span class="cstat-no" title="statement not covered" >      createInjector = shadowMode;</span>
<span class="cstat-no" title="statement not covered" >      shadowMode = false;</span>
    } // Vue.extend constructor export interop.
&nbsp;
&nbsp;
    var options = <span class="cstat-no" title="statement not covered" >typeof script === 'function' ? script.options : script;</span> // render functions
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (template &amp;&amp; template.render) {</span>
<span class="cstat-no" title="statement not covered" >      options.render = template.render;</span>
<span class="cstat-no" title="statement not covered" >      options.staticRenderFns = template.staticRenderFns;</span>
<span class="cstat-no" title="statement not covered" >      options._compiled = true; </span>// functional template
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isFunctionalTemplate) {</span>
<span class="cstat-no" title="statement not covered" >        options.functional = true;</span>
      }
    } // scopedId
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (scopeId) {</span>
<span class="cstat-no" title="statement not covered" >      options._scopeId = scopeId;</span>
    }
&nbsp;
    var hook;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (moduleIdentifier) {</span>
      // server build
<span class="cstat-no" title="statement not covered" >      hook = function <span class="fstat-no" title="function not covered" >hook(</span>context) {</span>
        // 2.3 injection
<span class="cstat-no" title="statement not covered" >        context = context || // cached call</span>
        this.$vnode &amp;&amp; this.$vnode.ssrContext || // stateful
        this.parent &amp;&amp; this.parent.$vnode &amp;&amp; this.parent.$vnode.ssrContext; // functional
        // 2.2 with runInNewContext: true
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!context &amp;&amp; typeof __VUE_SSR_CONTEXT__ !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >          context = __VUE_SSR_CONTEXT__;</span>
        } // inject component styles
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (style) {</span>
<span class="cstat-no" title="statement not covered" >          style.call(this, createInjectorSSR(context));</span>
        } // register component module identifier for async chunk inference
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (context &amp;&amp; context._registeredComponents) {</span>
<span class="cstat-no" title="statement not covered" >          context._registeredComponents.add(moduleIdentifier);</span>
        }
      }; // used by ssr in case component is cached and beforeCreate
      // never gets called
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      options._ssrRegister = hook;</span>
    } else <span class="cstat-no" title="statement not covered" >if (style) {</span>
<span class="cstat-no" title="statement not covered" >      hook = shadowMode ? <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >        style.call(this, createInjectorShadow(this.$root.$options.shadowRoot));</span>
      } : <span class="fstat-no" title="function not covered" >fu</span>nction (context) {
<span class="cstat-no" title="statement not covered" >        style.call(this, createInjector(context));</span>
      };
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (hook) {</span>
<span class="cstat-no" title="statement not covered" >      if (options.functional) {</span>
        // register for functional component in vue file
        var originalRender = <span class="cstat-no" title="statement not covered" >options.render;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        options.render = function <span class="fstat-no" title="function not covered" >renderWithStyleInjection(</span>h, context) {</span>
<span class="cstat-no" title="statement not covered" >          hook.call(context);</span>
<span class="cstat-no" title="statement not covered" >          return originalRender(h, context);</span>
        };
      } else {
        // inject component registration as beforeCreate hook
        var existing = <span class="cstat-no" title="statement not covered" >options.beforeCreate;</span>
<span class="cstat-no" title="statement not covered" >        options.beforeCreate = existing ? [].concat(existing, hook) : [hook];</span>
      }
    }
&nbsp;
...
&nbsp;
  var normalizeComponent_1 = <span class="cstat-no" title="statement not covered" >normalizeComponent;</span>
&nbsp;
  /* script */
  var __vue_script__ = <span class="cstat-no" title="statement not covered" >script;</span>
&nbsp;
  /* template */
  var __vue_render__ = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
      "div",
      {
  ...
  var __vue_staticRenderFns__ = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__ = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__ = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__ = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__ = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInput = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
  //
&nbsp;
  var script$1 = <span class="cstat-no" title="statement not covered" >{</span>
    provide: function <span class="fstat-no" title="function not covered" >provide </span>() {
<span class="cstat-no" title="statement not covered" >      return {</span>
    ...
    props: {
      ...
      formulateValue: {
        type: Object,
        default: <span class="fstat-no" title="function not covered" >fu</span>nction () { <span class="cstat-no" title="statement not covered" >return ({}); </span>}
      }
    },
    data: function <span class="fstat-no" title="function not covered" >data </span>() {
<span class="cstat-no" title="statement not covered" >      return {</span>
    ...
    computed: {
      formModel: {
        get: function <span class="fstat-no" title="function not covered" >get </span>() {
<span class="cstat-no" title="statement not covered" >          return this.formulateValue</span>
        },
        set: function <span class="fstat-no" title="function not covered" >set </span>(value) {
<span class="cstat-no" title="statement not covered" >          this.$emit('input', value);</span>
        }
      },
      hasFormulateValue: function <span class="fstat-no" title="function not covered" >hasFormulateValue </span>() {
<span class="cstat-no" title="statement not covered" >        return this.formulateValue &amp;&amp; typeof this.formulateValue === 'object'</span>
      },
      isVmodeled: function <span class="fstat-no" title="function not covered" >isVmodeled </span>() {
<span class="cstat-no" title="statement not covered" >        return !!(this.$options.propsData.hasOwnProperty('formulateValue') &amp;&amp;</span>
          this._events &amp;&amp;
          Array.isArray(this._events.input) &amp;&amp;
          this._events.input.length)
    ...
    watch: {
      formulateValue: {
        handler: function <span class="fstat-no" title="function not covered" >handler </span>(newValue, oldValue) {
<span class="cstat-no" title="statement not covered" >          if (this.isVmodeled &amp;&amp;</span>
            newValue &amp;&amp;
            typeof newValue === 'object'
          ) {
<span class="cstat-no" title="statement not covered" >            for (var field in newValue) {</span>
<span class="cstat-no" title="statement not covered" >              if (this.registry.hasOwnProperty(field) &amp;&amp; !shallowEqualObjects(newValue[field], this.registry[field].internalModelProxy)) {</span>
...
<span class="cstat-no" title="statement not covered" >                this.registry[field].context.model = newValue[field];</span>
              }
            }
          }
        },
    ...
    methods: {
      setFieldValue: function <span class="fstat-no" title="function not covered" >setFieldValue </span>(field, value) {
        var obj;
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.formModel = Object.assign({}, this.formulateValue, ( obj = {}, obj[field] = value, obj ));</span>
      },
      register: function <span class="fstat-no" title="function not covered" >register </span>(field, component) {
<span class="cstat-no" title="statement not covered" >        this.registry[field] = component;</span>
<span class="cstat-no" title="statement not covered" >        if (!component.$options.propsData.hasOwnProperty('formulateValue') &amp;&amp; this.hasFormulateValue &amp;&amp; this.formulateValue[field]) {</span>
          // In the case that the form is carrying an initial value and the
          // element is not, set it directly.
<span class="cstat-no" title="statement not covered" >          component.context.model = this.formulateValue[field];</span>
        }
      }
    }
  };
&nbsp;
  /* script */
  var __vue_script__$1 = <span class="cstat-no" title="statement not covered" >script$1;</span>
&nbsp;
  /* template */
  var __vue_render__$1 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
      ...
      {
        on: {
          submit: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
<span class="cstat-no" title="statement not covered" >            $event.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >            return _vm.formSubmitted($event)</span>
          }
        }
      },
      [_vm._t("default")],
  ...
  var __vue_staticRenderFns__$1 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$1._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$1 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$1 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$1 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$1 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateForm = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
  ...
  //
&nbsp;
  function <span class="fstat-no" title="function not covered" >objectWithoutProperties </span>(obj, exclude) { var target = <span class="cstat-no" title="statement not covered" >{};</span> <span class="cstat-no" title="statement not covered" >for (var k in obj) <span class="cstat-no" title="statement not covered" >if (Object.prototype.hasOwnProperty.call(obj, k) &amp;&amp; exclude.indexOf(k) === -1) <span class="cstat-no" title="statement not covered" >target[k] = obj[k]; <span class="cstat-no" title="statement not covered" ></span></span></span>return target; </span>}
  var script$2 = <span class="cstat-no" title="statement not covered" >{</span>
    ...
    computed: {
      options: function <span class="fstat-no" title="function not covered" >options </span>() {
<span class="cstat-no" title="statement not covered" >        return this.context.options || []</span>
      },
      optionsWithContext: function <span class="fstat-no" title="function not covered" >optionsWithContext </span>() {
        var this$1 = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
        var ref = <span class="cstat-no" title="statement not covered" >this.context;</span>
        var options = <span class="cstat-no" title="statement not covered" >ref.options;</span>
        var labelPosition = <span class="cstat-no" title="statement not covered" >ref.labelPosition;</span>
        var attributes = <span class="cstat-no" title="statement not covered" >ref.attributes;</span>
        var classification = <span class="cstat-no" title="statement not covered" >ref.classification;</span>
        var rest = <span class="cstat-no" title="statement not covered" >objectWithoutProperties( ref, ["options", "labelPosition", "attributes", "classification"] );</span>
        var context = <span class="cstat-no" title="statement not covered" >rest;</span>
<span class="cstat-no" title="statement not covered" >        return this.options.map(<span class="fstat-no" title="function not covered" >fu</span>nction (option) { <span class="cstat-no" title="statement not covered" >return this$1.groupItemContext(context, option); </span>})</span>
      }
    },
    methods: {
      groupItemContext: function <span class="fstat-no" title="function not covered" >groupItemContext </span>() {
        var args = <span class="cstat-no" title="statement not covered" >[],</span> len = <span class="cstat-no" title="statement not covered" >arguments.length;</span>
<span class="cstat-no" title="statement not covered" >        while ( len-- ) <span class="cstat-no" title="statement not covered" >args[ len ] = arguments[ len ];</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return Object.assign.apply(Object, [ {} ].concat( args, [{</span>
...
&nbsp;
  /* script */
  var __vue_script__$2 = <span class="cstat-no" title="statement not covered" >script$2;</span>
&nbsp;
  /* template */
  var __vue_render__$2 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
      ...
      _vm._l(_vm.optionsWithContext, <span class="fstat-no" title="function not covered" >fu</span>nction(optionContext) {
<span class="cstat-no" title="statement not covered" >        return _c(</span>
          ...
          _vm._b(
            {
              ...
              model: {
                ...
                callback: <span class="fstat-no" title="function not covered" >fu</span>nction($$v) {
<span class="cstat-no" title="statement not covered" >                  _vm.$set(_vm.context, "model", $$v);</span>
                },
  ...
  var __vue_staticRenderFns__$2 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$2._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$2 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$2 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$2 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$2 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInputGroup = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
   ...
   */
  var FormulateInputMixin = <span class="cstat-no" title="statement not covered" >{</span>
    props: {
      context: {
        type: Object,
        required: true
    ...
    computed: {
      type: function <span class="fstat-no" title="function not covered" >type </span>() {
<span class="cstat-no" title="statement not covered" >        return this.context.type</span>
      },
      id: function <span class="fstat-no" title="function not covered" >id </span>() {
<span class="cstat-no" title="statement not covered" >        return this.context.id</span>
      },
      attributes: function <span class="fstat-no" title="function not covered" >attributes </span>() {
<span class="cstat-no" title="statement not covered" >        return this.context.attributes || {}</span>
      },
      hasValue: function <span class="fstat-no" title="function not covered" >hasValue </span>() {
<span class="cstat-no" title="statement not covered" >        return !!this.context.model</span>
      }
    }
  };
&nbsp;
  //
&nbsp;
  var script$3 = <span class="cstat-no" title="statement not covered" >{</span>
    name: 'FormulateInputBox',
    mixins: [FormulateInputMixin]
  };
&nbsp;
  /* script */
  var __vue_script__$3 = <span class="cstat-no" title="statement not covered" >script$3;</span>
&nbsp;
  /* template */
  var __vue_render__$3 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
              ...
              _vm._b(
                {
                  ...
                  on: {
                    change: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
                      var $$a = <span class="cstat-no" title="statement not covered" >_vm.context.model,</span>
                        $$el = <span class="cstat-no" title="statement not covered" >$event.target,</span>
                        $$c = <span class="cstat-no" title="statement not covered" >$$el.checked ? true : false;</span>
<span class="cstat-no" title="statement not covered" >                      if (Array.isArray($$a)) {</span>
                        var $$v = <span class="cstat-no" title="statement not covered" >_vm.context.value,</span>
                          $$i = <span class="cstat-no" title="statement not covered" >_vm._i($$a, $$v);</span>
...
<span class="cstat-no" title="statement not covered" >                        _vm.$set(_vm.context, "model", $$c);</span>
                      }
                    }
                  }
                },
              ...
              _vm._b(
                {
                  ...
                  on: {
                    change: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
<span class="cstat-no" title="statement not covered" >                      return _vm.$set(_vm.context, "model", _vm.context.value)</span>
                    }
                  }
                },
                "input",
              ...
              _vm._b(
                {
                  ...
                  on: {
                    input: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
<span class="cstat-no" title="statement not covered" >                      if ($event.target.composing) {</span>
<span class="cstat-no" title="statement not covered" >                        return</span>
                      }
<span class="cstat-no" title="statement not covered" >                      _vm.$set(_vm.context, "model", $event.target.value);</span>
                    }
                  }
                },
                "input",
  ...
  var __vue_staticRenderFns__$3 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$3._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$3 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$3 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$3 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$3 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInputBox = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
  //
&nbsp;
  var script$4 = <span class="cstat-no" title="statement not covered" >{</span>
    name: 'FormulateInputText',
    mixins: [FormulateInputMixin]
  };
&nbsp;
  /* script */
  var __vue_script__$4 = <span class="cstat-no" title="statement not covered" >script$4;</span>
&nbsp;
  /* template */
  var __vue_render__$4 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
                  ...
                  on: {
                    change: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
                      var $$a = <span class="cstat-no" title="statement not covered" >_vm.context.model,</span>
                        ...
                        $$c = <span class="cstat-no" title="statement not covered" >$$el.checked ? true : false;</span>
<span class="cstat-no" title="statement not covered" >                      if (Array.isArray($$a)) {</span>
                        var $$v = <span class="cstat-no" title="statement not covered" >null,</span>
                          $$i = <span class="cstat-no" title="statement not covered" >_vm._i($$a, $$v);</span>
<span class="cstat-no" title="statement not covered" >                        if ($$el.checked) {</span>
<span class="cstat-no" title="statement not covered" >                          $$i &lt; 0 &amp;&amp;</span>
                            _vm.$set(_vm.context, "model", $$a.concat([$$v]));
              ...
              _vm._b(
                {
                  ...
                  on: {
                    change: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
<span class="cstat-no" title="statement not covered" >                      return _vm.$set(_vm.context, "model", null)</span>
                    }
                  }
                },
                "input",
...
<span class="cstat-no" title="statement not covered" >                      _vm.$set(_vm.context, "model", $event.target.value);</span>
  ...
  var __vue_staticRenderFns__$4 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$4._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$4 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$4 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$4 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$4 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInputText = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
  //
&nbsp;
  var script$5 = <span class="cstat-no" title="statement not covered" >{</span>
...
<span class="cstat-no" title="statement not covered" >        return this.context.options || {}</span>
      ...
      optionGroups: function <span class="fstat-no" title="function not covered" >optionGroups </span>() {
<span class="cstat-no" title="statement not covered" >        return this.context.optionGroups || false</span>
      },
      placeholderSelected: function <span class="fstat-no" title="function not covered" >placeholderSelected </span>() {
<span class="cstat-no" title="statement not covered" >        return !!(!this.hasValue &amp;&amp; this.context.attributes &amp;&amp; this.context.attributes.placeholder)</span>
      }
    }
  };
&nbsp;
  /* script */
  var __vue_script__$5 = <span class="cstat-no" title="statement not covered" >script$5;</span>
&nbsp;
  /* template */
  var __vue_render__$5 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
          ...
          _vm._b(
            {
              ...
              on: {
                change: <span class="fstat-no" title="function not covered" >fu</span>nction($event) {
                  var $$selectedVal = <span class="cstat-no" title="statement not covered" >Array.prototype.filter</span>
                    .call($event.target.options, <span class="fstat-no" title="function not covered" >fu</span>nction(o) {
<span class="cstat-no" title="statement not covered" >                      return o.selected</span>
                    })
                    .map(<span class="fstat-no" title="function not covered" >fu</span>nction(o) {
                      var val = <span class="cstat-no" title="statement not covered" >"_value" in o ? o._value : o.value;</span>
<span class="cstat-no" title="statement not covered" >                      return val</span>
                    });
<span class="cstat-no" title="statement not covered" >                  _vm.$set(</span>
                    _vm.context,
                    "model",
          ...
          [
            ...
            _vm._v(" "),
            !_vm.optionGroups
              ? _vm._l(_vm.options, <span class="fstat-no" title="function not covered" >fu</span>nction(option) {
<span class="cstat-no" title="statement not covered" >                  return _c(</span>
                    "option",
                    _vm._b(
                      {
              ...
              : _vm._l(_vm.optionGroups, <span class="fstat-no" title="function not covered" >fu</span>nction(subOptions, label) {
<span class="cstat-no" title="statement not covered" >                  return _c(</span>
                    "optgroup",
                    { key: label, attrs: { label: label } },
                    _vm._l(subOptions, <span class="fstat-no" title="function not covered" >fu</span>nction(option) {
<span class="cstat-no" title="statement not covered" >                      return _c(</span>
                        "option",
                        _vm._b(
                          {
  ...
  var __vue_staticRenderFns__$5 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$5._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$5 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$5 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$5 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$5 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInputSelect = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
  //
&nbsp;
  var script$6 = <span class="cstat-no" title="statement not covered" >{</span>
    name: 'FormulateInputTextArea',
    mixins: [FormulateInputMixin]
  };
&nbsp;
  /* script */
  var __vue_script__$6 = <span class="cstat-no" title="statement not covered" >script$6;</span>
&nbsp;
  /* template */
  var __vue_render__$6 = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    var _vm = <span class="cstat-no" title="statement not covered" >this;</span>
    var _h = <span class="cstat-no" title="statement not covered" >_vm.$createElement;</span>
    var _c = <span class="cstat-no" title="statement not covered" >_vm._self._c || _h;</span>
<span class="cstat-no" title="statement not covered" >    return _c(</span>
...
<span class="cstat-no" title="statement not covered" >                  _vm.$set(_vm.context, "model", $event.target.value);</span>
  ...
  var __vue_staticRenderFns__$6 = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >  __vue_render__$6._withStripped = true;</span>
&nbsp;
    /* style */
    var __vue_inject_styles__$6 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* scoped */
    var __vue_scope_id__$6 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* module identifier */
    var __vue_module_identifier__$6 = <span class="cstat-no" title="statement not covered" >undefined;</span>
    /* functional template */
    var __vue_is_functional_template__$6 = <span class="cstat-no" title="statement not covered" >false;</span>
    /* style inject */
...
&nbsp;
    ...
    var FormulateInputTextArea = <span class="cstat-no" title="statement not covered" >normalizeComponent_1(</span>
...
&nbsp;
   ...
   */
  var Formulate = <span class="cstat-no" title="statement not covered" >function <span class="fstat-no" title="function not covered" >Formulate </span>() {</span>
<span class="cstat-no" title="statement not covered" >    this.defaults = {</span>
      components: {
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  Formulate.prototype.install = function <span class="fstat-no" title="function not covered" >install </span>(Vue, options) {</span>
<span class="cstat-no" title="statement not covered" >    Vue.prototype.$formulate = this;</span>
<span class="cstat-no" title="statement not covered" >    this.options = this.extend(this.defaults, options || {});</span>
<span class="cstat-no" title="statement not covered" >    for (var componentName in this.options.components) {</span>
<span class="cstat-no" title="statement not covered" >      Vue.component(componentName, this.options.components[componentName]);</span>
    }
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  Formulate.prototype.extend = function <span class="fstat-no" title="function not covered" >extend </span>(base, extendWith) {</span>
    var merged = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >    for (var key in base) {</span>
<span class="cstat-no" title="statement not covered" >      if (extendWith.hasOwnProperty(key)) {</span>
<span class="cstat-no" title="statement not covered" >        merged[key] = isPlainObject(extendWith[key]) &amp;&amp; isPlainObject(base[key])</span>
          ? this.extend(base[key], extendWith[key])
          : extendWith[key];
      } else {
<span class="cstat-no" title="statement not covered" >        merged[key] = base[key];</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    for (var prop in extendWith) {</span>
<span class="cstat-no" title="statement not covered" >      if (!merged.hasOwnProperty(prop)) {</span>
<span class="cstat-no" title="statement not covered" >        merged[prop] = extendWith[prop];</span>
      }
    }
...
&nbsp;
   ...
   * @param {string} type
   */
<span class="cstat-no" title="statement not covered" >  Formulate.prototype.classify = function <span class="fstat-no" title="function not covered" >classify </span>(type) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.options.library.hasOwnProperty(type)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.options.library[type].classification</span>
    }
...
&nbsp;
   ...
   * @param {string} type
   */
<span class="cstat-no" title="statement not covered" >  Formulate.prototype.component = function <span class="fstat-no" title="function not covered" >component </span>(type) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.options.library.hasOwnProperty(type)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.options.library[type].component</span>
    }
<span class="cstat-no" title="statement not covered" >    return false</span>
  };
&nbsp;
  var Formulate$1 = <span class="cstat-no" title="statement not covered" >new Formulate();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.default = Formulate$1;</span>
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Oct 30 2019 09:38:00 GMT-0400 (Eastern Daylight Time)
</div>
</div>
